...
class T5Block(nn.Module):
    """
    Modified version of T5Block from Huggingface code without decoder aspects
    """
...
class T5Stack(T5PreTrainedModel):
    """
        Modified version of T5Stack from Huggingface code without decoder aspects and added gradient checkpointing
    """
